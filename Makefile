...
LIBS := devlock.c tklock.c modetransition.c powerkey.c connectivity.c mce-dbus.c mce-dsme.c mce-gconf.c event-input.c event-switches.c mce-log.c mce-conf.c datapipe.c mce-modules.c mce-io.c mce-lib.c event-input-utils.c x11-utils.c
HEADERS := devlock.h tklock.h modetransition.h powerkey.h connectivity.h mce.h mce-dbus.h mce-dsme.h mce-gconf.h event-input.h event-switches.h mce-log.h mce-conf.h datapipe.h mce-modules.h mce-io.h mce-lib.h event-input-utils.h x11-utils.h
